...
ControllerAll = false
local ListSudos ={Sudo_Id,5059929874,2104371598,5273819032}  
...
Status = 'حــــســــام الــــهــــولـــنــــدي ✶ ✶🇳🇱'
elseif UserId == 2104371598 then  
Status = 'الـمـطـور ديـشـا'
...
msg.Name_Controller = 'الـمـطـور حـسـام'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 2104371598 then
msg.Name_Controller = 'الـمـطـور ديـشـا'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5273819032 then
msg.Name_Controller = 'الـمـطـور فـيـرس'
msg.The_Controller = 1
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/APP_YOUTUBE'}, },}}
...
--download('https://raw.githubusercontent.com/BaBaNeyork/Neyorklua/master/MEZO.lua','MEZO.lua')
...
Get_Json = Get_Json..'"Dev":"H_OS_S_AM"}'
end
Get_Json = Get_Json..'}}'
...
NamesBot = (Redis:get(MEZO.."MEZO:Name:Bot") or "لديشا")
...
{
{text = Jabwa, url = 't.me/APP_YOUTUBE'}, 
},
{
{text = Grosupsw, url = 't.me/APP_YOUTUBE'}, 
},
{
{text = Usperos, url = 't.me/APP_YOUTUBE'}, 
},
}
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج ديـشـا' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ● عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج ديـشـا' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ● عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
...
if Controller(msg_chat_id,UserId) == 'المبرمج ديـشـا' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  ● عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId).." 』*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'مبرمج السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  ● عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId).." 』*","md",true)  
...
keyboard.inline_keyboard = {
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗔𝗘𝗦𝗧𝗥𝗢┋✘🇨🇦!', url = "https://t.me/APP_YOUTUBE"}
},
}
...
photo = "https://telegra.ph/file/599b302fc0fb423b8ed22.jpg"
local T =[[
⦑Wᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ɴᴇʏᴏʀᴋ⦒ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '✯𝐌𝐒✯ 𝒅𝒆𝒔𝒉𝒂┋✘🇨🇦!', url = "https://t.me/J3_X3"}
},
{
{text = '✯𝐌𝐒✯ 𝒗𝒊𝒓𝒖𝒔┋✘🇨🇦!', url = "https://t.me/FLASH_MASR"}
},
{
{text = 'حــــســــام الــــهــــولـــنــــدي ✶ ✶🇳🇱', url = "https://t.me/H_OS_S_AM"}
},
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗔𝗘𝗦𝗧𝗥𝗢┋✘🇨🇦!', url = "https://t.me/APP_YOUTUBE"}
},
...
elseif text == 'حـسـام' or text == 'حسام' or text == 'حــــســــام الــــهــــولـــنــــدي ✶ ✶🇳🇱' then
photo = "https://telegra.ph/file/599b302fc0fb423b8ed22.jpg"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ حــــســــام الــــهــــولـــنــــدي ✶ ✶🇳🇱 \n ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'حــــســــام الــــهــــولـــنــــدي ✶ ✶🇳🇱', url = "https://t.me/H_OS_S_AM"}
...
elseif text == 'ديشا' or text == 'ديشا' or text == 'الـمـطـور ديـشـا' then
photo = "https://telegra.ph/file/599b302fc0fb423b8ed22.jpg"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ Dev 𝒅𝒆𝒔𝒉𝒂 \n ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '✯𝐌𝐒✯ 𝒅𝒆𝒔𝒉𝒂┋✘🇨🇦!', url = "https://t.me/J3_X3"}
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'فيرس' or text == 'فيروس' or text == 'الـمـطـور فـيـرس' then
photo = "https://telegra.ph/file/599b302fc0fb423b8ed22.jpg"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ Dev ⱴᎥⲅᵴ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '✯𝐌𝐒✯ 𝒗𝒊𝒓𝒖𝒔┋✘🇨🇦!', url = "https://t.me/FLASH_MASR"}
...
return LuaTele.sendText(msg_chat_id,msg_id,'● اليك قسم الالعاب من سورس لديشا ●',"md",false, false, false, false, reply_markup)
end
...
local NamesBot = (Redis:get(MEZO.."MEZO:Name:Bot") or "لديشا")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/APP_YOUTUBE'}, 
},
{
...
if text == (Redis:get(MEZO.."MEZO:Name:Bot") or "لديشا") then
local photo = LuaTele.getUserProfilePhotos(MEZO)
local ban = LuaTele.getUser(MEZO)
for Name_User in string.gmatch(ban.first_name, "[^%s]+" ) do
ban.first_name = Name_User
...
local CmdStart = '*\n ● أهلآ بك في بوت '..(Redis:get(MEZO.."MEZO:Name:Bot") or "لديشا")..
